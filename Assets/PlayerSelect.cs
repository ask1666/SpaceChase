...
public class PlayerSelect : MonoBehaviour {
    ...
    public void OnPlayerClick() {
        PlayerData playerData = new PlayerData(0, 1, 3, 0, "Player");
        SaveSystem.SavePlayerData(playerData);
        SceneManager.LoadScene("MainMenu"); 
    }

    public void OnPlayer2Click() {
        PlayerData playerData = new PlayerData(0, 1, 3, 0, "Player2");
        SaveSystem.SavePlayerData(playerData);
        SceneManager.LoadScene("MainMenu");
    }
    ...
    public void OnPlayer4Click() {
        PlayerData playerData = new PlayerData(0, 1, 3, 0, "Player4");
        SaveSystem.SavePlayerData(playerData);
        SceneManager.LoadScene("MainMenu");
    }
}
